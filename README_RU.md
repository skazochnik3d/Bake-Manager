...
- `Live Project Folder` - синхронизирует файлы проекта с папками в Проводнике.
...
> [!NOTE]
>
> Используйте `__` для разделения папок, а `_` - внутри названия слоя.
> Например, `Cube__N__Fix_01.png` будет назначен по пути: `Cube → N → Fix_01`
> Если нужных папок или слоя нет, плагин создаст их автоматически.
